...
- There are different levels of snow coverage depending on the exposure to skylight and blocklight.
...
This branch supports `Minecraft` versions from `1.21.5` to `1.21.7`.
...
Simply place the mod file `leavesly-1.4.0+1.21.7.jar` in your `.minecraft\mods` folder, and load Minecraft using [Fabric](https://fabricmc.net/use/installer) or [Quilt](https://quiltmc.org/en/install).
