...
This branch supports `Minecraft` version `1.21.5`.
...
Simply place the mod file `leavesly-1.4.0+1.21.5.jar` in your `.minecraft\mods` folder, and load Minecraft using [Fabric](https://fabricmc.net/use/installer) or [Quilt](https://quiltmc.org/en/install).
