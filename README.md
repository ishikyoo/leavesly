...
This branch supports `Minecraft` versions from `1.21.5` to `1.21.6`.
...
Simply place the mod file `leavesly-1.4.0+1.21.6.jar` in your `.minecraft\mods` folder, and load Minecraft using [Fabric](https://fabricmc.net/use/installer) or [Quilt](https://quiltmc.org/en/install).
